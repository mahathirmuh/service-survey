...
async function addAllExternalColumns() {
  try {
    console.log('🔄 Adding all external columns to survey_responses table...');
...
`);
    ...
    console.log('✅ All external columns added successfully!');
    return true;
  } catch (error) {
...
async function verifyAllExternalColumns() {
  try {
    console.log('🔍 Verifying all external columns...');
    ...
    console.log('✅ All external columns verified');
    return true;
  } catch (error) {
...
async function main() {
  try {
    ...
    if (columnsVerified) {
      ...
      console.log('1. ✅ Added all external columns to survey_responses table');
      ...
      console.log('\n❌ Failed to add or verify all external columns.');
